...
if ("serviceWorker" in navigator && location.protocol !== "file:") navigator.serviceWorker.register("./sw.js?v=26", { updateViaCache: "none" }).catch(() => {});
saveState();
navigate("home");
